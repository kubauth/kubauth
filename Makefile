...
.PHONY: chart-yaml
chart-yaml: ## Generate the helm/kubauth/Chart.yaml
	echo "$$CHART_YAML" >./helm/kubauth/Chart.yaml

.PHONY: chart
chart: chart-yaml crds ## Build and push controller helm chart
	cd ./helm && helm package -d ./../tmp kubauth && helm push ./../tmp/kubauth-${HELM_VERSION}.tgz oci://${HELM_DOCKER_REPO}
